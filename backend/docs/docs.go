...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/comments/{commentId}/like": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid comment ID or deleted comment",
                        "schema": {
                            "$ref": "#/definitions/dto.ErrorResponse"
                        }
                    },
        ...
        "/comments/{commentId}/replies": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Cursor for pagination (last reply ID)",
                        "name": "cursor",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/dto.CommentsListResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid comment ID",
                ...
                "parameters": [
                    {
                        "type": "string",
                        "example": "\"john_doe\"",
                        "description": "Day owner username",
                        "name": "username",
                        "in": "path",
                        "required": true
                    },
                    ...
                    },
                    {
                        ...
                        "type": "string",
                        "default": "top",
                        "description": "Sort order: top or newest",
                        "name": "sort",
                        "in": "query"
                    },
                    {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/dto.CommentActionResponse"
                        }
                    },
                    "400": {
                        "description": "Validation error",
        ...
        "/days/{username}/{date}/comments/count": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/dto.CommentCountResponse"
                        }
                    },
                    "400": {
                        "description": "Validation error",
        ...
        "dto.CommentDTO": {
            ...
            "properties": {
                ...
                "mentions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.MentionDTO"
                    }
                },
                "parent_comment_id": {
                    "type": "integer"
