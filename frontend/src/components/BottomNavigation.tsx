...
import { Home, Settings2, BarChart3, User as UserIcon } from 'lucide-react';
...
export const BottomNavigation: React.FC<BottomNavigationProps> = ({ onCustomizeTiles }) => {
    ...
    const isHome = location.pathname === APP_ROUTES.HOME || location.pathname === '/' || location.pathname.startsWith('/user/');
    const isAnalytics = location.pathname === APP_ROUTES.ANALYTICS || location.pathname.startsWith('/analytics');
