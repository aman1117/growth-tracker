...
export const HoursSummary: React.FC<HoursSummaryProps> = ({ activities, loading = false }) => {
  ...
  return (
    ...
    >
      ...
      >
        {React.createElement(getStatusIcon(), { size: 24, color: getStatusColor() })}
      </div>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        >
          {totalHours >= maxHours ? (
            <span style={{ color: 'var(--success)', fontWeight: 600 }}>✓ Day fully logged</span>
          ) : totalHours > maxHours ? (
            <span style={{ color: 'var(--error)', fontWeight: 600 }}>⚠ Over 24 hours logged</span>
          ) : (
