 ...
 * 
 * Verified badge (gold checkmark) displayed next to verified users.
 */
...
/**
 * A verified badge component that displays a gold checkmark.
 * 
 * @example
 * ```tsx
 * // Basic usage
...
export const VerifiedBadge: React.FC<VerifiedBadgeProps> = ({
  ...
  return (
    ...
    >
      <title>{title}</title>
      {/* Verified badge with star/burst shape - Gold/Amber color */}
      <path
        fill="var(--color-badge, #f59e0b)"
      ...
      />
      {/* Checkmark - white in light mode, dark in dark mode */}
      <path
        fill="var(--verified-check-color, #ffffff)"
